...
const questions = [
    ...
    { id: 6, text: "Before answering a question in class, I usually need time to organize my thoughts privately.", trait: "E", direction: -1 },
    { id: 7, text: "I would enjoy joining a finance club activity where I can meet seniors or guest speakers.", trait: "E", direction: 1 },
    { id: 8, text: "I prefer written instructions or notes over long verbal discussions.", trait: "E", direction: -1 },
    { id: 9, text: "I feel more motivated when I can talk through a finance problem with other people.", trait: "E", direction: 1 },
    { id: 10, text: "I can focus better when I work on a financial calculation or reading task independently.", trait: "E", direction: -1 },
    { id: 11, text: "I am comfortable asking questions during a beginner-level finance workshop.", trait: "E", direction: 1 },
    { id: 12, text: "I usually observe first before participating in a new group discussion.", trait: "E", direction: -1 },
    { id: 13, text: "I would feel confident presenting a short summary of a company or bank case to classmates.", trait: "E", direction: 1 },
    { id: 14, text: "I prefer preparing the analysis part of a presentation rather than being the main speaker.", trait: "E", direction: -1 },
    { id: 15, text: "I feel comfortable communicating with new people when the topic is related to study or career exploration.", trait: "E", direction: 1 },

    // --- Table 2: S vs N ---
    { id: 16, text: "When learning a finance concept, I prefer clear examples with numbers before discussing the theory behind it.", trait: "S", direction: 1 },
    { id: 17, text: "I enjoy thinking about how banking, fintech, or investing may change in the future.", trait: "S", direction: -1 },
    { id: 18, text: "When reading about a company, I prefer starting with basic facts such as revenue, costs, and products.", trait: "S", direction: 1 },
    { id: 19, text: "I often wonder what larger trend may be behind a piece of financial news.", trait: "S", direction: -1 },
    { id: 20, text: "I feel more confident when a finance task has clear instructions and specific data.", trait: "S", direction: 1 },
    { id: 21, text: "I enjoy connecting different topics, such as economics, business, and technology, into one bigger picture.", trait: "S", direction: -1 },
    { id: 22, text: "I prefer learning from real cases rather than from abstract explanations only.", trait: "S", direction: 1 },
    { id: 23, text: "I am interested in imagining possible future outcomes before all details are confirmed.", trait: "S", direction: -1 },
    { id: 24, text: "When solving a beginner finance problem, I focus first on the information that is already given.", trait: "S", direction: 1 },
    { id: 25, text: "I enjoy discussing what might happen to an industry or market in the next few years.", trait: "S", direction: -1 },
    { id: 26, text: "I prefer checking exact definitions and formulas before applying a finance concept.", trait: "S", direction: 1 },
    { id: 27, text: "I like exploring new ideas, even when they are not immediately practical.", trait: "S", direction: -1 },
    { id: 28, text: "I usually trust verified information more than assumptions or predictions.", trait: "S", direction: 1 },
    { id: 29, text: "I am comfortable making a reasonable guess when a business case does not provide complete information.", trait: "S", direction: -1 },
    { id: 30, text: "I prefer tasks where I can follow a clear example before trying a new approach.", trait: "S", direction: 1 },

    // --- Table 3: T vs F ---
    { id: 31, text: "When comparing two finance options, I prefer using clear criteria such as cost, risk, and benefit.", trait: "T", direction: 1 },
    { id: 32, text: "When discussing money-related decisions, I think people’s feelings and comfort level should be considered.", trait: "T", direction: -1 },
    { id: 33, text: "If the numbers do not support an idea, I am comfortable saying that the idea may not be suitable.", trait: "T", direction: 1 },
    { id: 34, text: "I try to avoid making others feel embarrassed when correcting a mistake in group work.", trait: "T", direction: -1 },
    { id: 35, text: "When reviewing a simple business case, I first ask whether the reasoning is logical.", trait: "T", direction: 1 },
    { id: 36, text: "I think trust is very important when explaining financial information to someone else.", trait: "T", direction: -1 },
    { id: 37, text: "I prefer feedback that directly tells me what is wrong and how to improve it.", trait: "T", direction: 1 },
    { id: 38, text: "I pay attention to whether people feel respected during a group discussion.", trait: "T", direction: -1 },
    { id: 39, text: "I would choose the option with stronger evidence, even if it is not the most popular choice.", trait: "T", direction: 1 },
    { id: 40, text: "I care about how a financial decision may affect a person’s daily life.", trait: "T", direction: -1 },
    { id: 41, text: "When doing a finance assignment, I prefer objective scoring or clear standards.", trait: "T", direction: 1 },
    { id: 42, text: "I value cooperation and group harmony when working with classmates.", trait: "T", direction: -1 },
    { id: 43, text: "I am comfortable making a difficult decision if the logic behind it is strong.", trait: "T", direction: 1 },
    { id: 44, text: "I believe financial explanations should be easy for people to understand and not make them feel pressured.", trait: "T", direction: -1 },
    { id: 45, text: "I usually trust evidence and structured reasoning more than personal impressions.", trait: "T", direction: 1 },

    // --- Table 4: J vs P ---
    { id: 46, text: "Before starting a finance assignment, I prefer making a simple plan or checklist.", trait: "J", direction: 1 },
    { id: 47, text: "I can work comfortably when a group project changes direction after new information appears.", trait: "J", direction: -1 },
    { id: 48, text: "I like setting deadlines for each part of a report, presentation, or calculation task.", trait: "J", direction: 1 },
    { id: 49, text: "I prefer keeping several possible approaches open before choosing one final answer.", trait: "J", direction: -1 },
    { id: 50, text: "I feel more confident when I know exactly what needs to be submitted.", trait: "J", direction: 1 },
    { id: 51, text: "I enjoy exploring different ways to understand a business or finance problem.", trait: "J", direction: -1 },
    { id: 52, text: "I usually complete required tasks before spending time on extra ideas.", trait: "J", direction: 1 },
    { id: 53, text: "I can stay productive even when instructions are not very detailed.", trait: "J", direction: -1 },
    { id: 54, text: "I like organizing information into tables, categories, or bullet points.", trait: "J", direction: 1 },
    { id: 55, text: "I do not mind changing my plan if a better idea appears later.", trait: "J", direction: -1 },
    { id: 56, text: "I prefer preparing early for presentations, exams, or group deadlines.", trait: "J", direction: 1 },
    { id: 57, text: "I enjoy tasks where I can experiment instead of following one fixed process.", trait: "J", direction: -1 },
    { id: 58, text: "I prefer making decisions early so I can focus on completing the task.", trait: "J", direction: 1 },
    { id: 59, text: "I am comfortable waiting for more information before making a final conclusion.", trait: "J", direction: -1 },
    { id: 60, text: "I feel satisfied when a study task follows a clear process from start to finish.", trait: "J", direction: 1 }
];
